        ...
        {offerListings && offerListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-blue-500 hover:text-violet-500 hover:underline' to={'/search?offer=true'}>Show more offers</Link>
            </div>
        ...
        {saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-blue-500 hover:text-violet-500 hover:underline' to={'/search?type=sale'}>Show more places for sale</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
