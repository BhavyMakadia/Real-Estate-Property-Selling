...
export default function AdminCreateListing() {
  ...
  return (
    <main className='pl-60 p-3 max-w-4xl mx-auto'>
      <h1 className=' text-orange-200 text-2xl font-bold text-center my-9'>
        Create a Listing
      </h1>
...
<span className=" font-semibold inline-block p-2   rounded text-red-600 bg-red-200 uppercase last:mr-0 mr-1">
  ...
  Enter below details carefully:-
          ...
          <div className='flex flex-wrap gap-6  font-bold text-slate-200'>
